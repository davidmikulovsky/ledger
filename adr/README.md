...
- [0007 — Group representation and spin-off model](0007-group-representation-and-spin-off-model.md) — ventures modeled as independent top-level units linked by `parent:` + `portfolio_members:`, not nested `sub_units:`; spin-off = drop the link. Supersedes the `sub_units:` convention.
